            ...
            else
            {
                ...
                if ((var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && par4 < 256 - var6 - 1)
                {
                    ...
                    for (var11 = par4 - var9 + var6; var11 <= par4 + var6; ++var11)
                    {
                        ...
                        for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
                        {
                            ...
                            for (int var16 = par5 - var13; var16 <= par5 + var13; ++var16)
                            {
                                ...
                                {
                                    this.setBlockAndMetadata(par1World, var14, var11, var16, ModBlocks.OrangeLeaf.blockID, this.metaLeaves);
                                }
                            }
                        }
                    }
                    ...
                    for (var11 = 0; var11 < var6; ++var11)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + var11, par5, ModBlocks.OrangeLog.blockID, this.metaWood);
                            ...
                            for (var11 = 0; var11 < 2; ++var11)
                            {
                                for (var12 = 0; var12 < 4; ++var12)
                                {
                                    if (par2Random.nextInt(4 - var11) == 0)
                                    {
                                        ...
                                        this.setBlockAndMetadata(par1World, par3 + Direction.offsetX[Direction.facingToDirection[var12]], par4 + var6 - 5 + var11, par5 + Direction.offsetZ[Direction.facingToDirection[var12]], Block.cocoaPlant.blockID, var13 << 2 | var12);
                                    }
                                }
                            }
                        }
