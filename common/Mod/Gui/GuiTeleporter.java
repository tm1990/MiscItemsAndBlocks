  ...
  protected void drawGuiContainerForegroundLayer(int param1, int param2) {
	...
	protected void drawGuiContainerBackgroundLayer(float f, int X, int Y)
	{
	    ...
	    Minecraft.getMinecraft().renderEngine.bindTexture(Texture);
	     	...
	     	this.drawString(fontRenderer, "Power: " + tile.GetPower() + "/" + tile.PowerMax, x + 62, y + 44, 0x666666);
	     	...
	     	if(CardMode == 1){
	     		...
	     		this.drawString(fontRenderer, "Linked to: ", x + 62, y + 53, 0x666666);
	     		this.drawString(fontRenderer, "X: " + tile.GetX() + " Y: " + tile.GetY() + " Z: " + tile.GetZ(), x + 62, y + 62, 0x666666);
	     	}
