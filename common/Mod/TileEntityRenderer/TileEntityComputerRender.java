...
import Mod.Models.ComputerModel;
import Mod.TileEntity.TileEntityComputer;

public class TileEntityComputerRender extends TileEntitySpecialRenderer {
    
    private final ComputerModel model;
   
    public TileEntityComputerRender() {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
    	if(te instanceof TileEntityComputer){
            ...
            bindTexture(new ResourceLocation("miscitems" , "textures/models/ComputerBlockModel.png"));
